...
const messages = {
  en: {
    ...
    usage: {
      ...
      log: "Usage log",
      logHint: "Sorted by newest entries first. Badges distinguish actual upstream usage from estimated passthrough or convert usage.",
      previous: "Previous",
      next: "Next",
  ...
  zh: {
    ...
    usage: {
      ...
      log: "用量日志",
      logHint: "按最新时间排序。徽标会区分真实上游用量与 passthrough/convert 的估算用量。",
      previous: "上一页",
      next: "下一页",
      errorTitle: "用量数据加载失败。",
