    ...
    <div class="max-w-[1400px] mx-auto px-4 md:px-8 py-10">
      <div class="grid grid-cols-1 md:grid-cols-[240px_1fr] gap-10">
        <aside class="space-y-8">
          <div class="glass-panel rounded-2xl p-5 subtle-ring">
          ...
          <nav class="space-y-2">
            <NuxtLink
              to="/providers"
              class="block rounded-xl px-4 py-3 text-sm font-medium text-slate-700 transition-all hover:bg-white/70 hover:text-slate-900 action-press"
